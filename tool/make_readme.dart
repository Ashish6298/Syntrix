...
void main() {
  const content = r'''<div align="center">
...
| **[Why Syntrix over `flutter create`?](#why-syntrix-over-flutter-create)** | Feature-by-feature comparison matrix vs traditional tooling | Decision Makers & Engineers |
...
## Why Syntrix over `flutter create`?
...
| **Audit Engine** | ❌ None | ❌ None | **✅ 5-Profile deterministic audit (`basic`, `standard`, `strict`, `release`)** |
