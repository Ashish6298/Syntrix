...
import 'package:syntrix/src/commands/template_command.dart';
import 'package:syntrix/src/commands/plugin_command.dart';

export 'package:syntrix/src/commands/template_command.dart';
export 'package:syntrix/src/commands/plugin_command.dart';
export 'package:syntrix/src/commands/project_command.dart';
export 'package:syntrix/src/commands/review_command.dart';
export 'package:syntrix/src/commands/ai_test_command.dart';
export 'package:syntrix/src/commands/debug_command.dart';
export 'package:syntrix/src/commands/architecture_command.dart';
...
///
/// Inherits from [TemplateCatalogCommand] which hosts the full `list`, `search`,
/// and `info` subcommand family.
///
/// [TemplateCommand] is kept for backward compatibility with
/// existing code that registers it by name.
class TemplateCommand extends TemplateCatalogCommand {}

/// Command to manage CLI plugins.
///
/// Inherits from [PluginCatalogCommand] which hosts the full `list`, `discover`,
/// `info`, `validate`, `enable`, `disable`, and `inspect` subcommand family.
///
/// [PluginCommand] is kept for backward compatibility with
/// existing code that registers it by name.
class PluginCommand extends PluginCatalogCommand {}
