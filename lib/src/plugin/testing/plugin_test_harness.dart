...
import 'package:syntrix/src/plugin/configuration/plugin_configuration_validator.dart';
...
import 'package:syntrix/src/plugin/diagnostics/plugin_diagnostics_engine.dart';
...
import 'package:syntrix/src/plugin/lifecycle/plugin_lifecycle_manager.dart';
...
import 'package:syntrix/src/plugin/runtime/plugin_execution_runtime.dart';
import 'package:syntrix/src/plugin/testing/plugin_sandbox_models.dart';
import 'package:syntrix/src/plugin/trust/plugin_trust_gate.dart';
import 'package:syntrix/src/plugin/upgrade/plugin_upgrade_manager.dart';
import 'package:syntrix/src/plugin/removal/plugin_removal_manager.dart';
import 'package:syntrix/src/plugin/integration/plugin_integration_service.dart';
import 'package:syntrix/src/plugin/certification/plugin_architecture_certifier.dart';
import 'package:syntrix/src/release/git/git_process_runner.dart';

import 'package:syntrix/src/release/git/git_release_manager.dart';
import 'package:syntrix/src/release/github/github_api_client.dart';
import 'package:syntrix/src/release/publishing/package_publishing_manager.dart';
...
class PluginTestHarness {
  ...
  final PluginIntegrationService integrationServiceHarness;
  final PluginArchitectureCertifier certifierHarness;
  ...
  PluginTestHarness._({
    ...
    required this.integrationServiceHarness,
    required this.certifierHarness,
  });
  ...
  factory PluginTestHarness.create({
    ...
    final integrationService = PluginIntegrationService(
      rootPath: sandboxDir.path,
      registry: registry,
      stateStore: stateStore,
      discoveryEngine: discovery,
    );
    final certifier = PluginArchitectureCertifier();
    ...
    return PluginTestHarness._(
      ...
      integrationServiceHarness: integrationService,
      certifierHarness: certifier,
    );
  }
