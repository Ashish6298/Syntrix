...
class ApiFreezeEngine {
  ...
  ApiFreezeAuditReport runApiFreezeAudit({String targetVersion = '1.0.0'}) {
    _logger.info('Executing Phase 11.1: Final API Freeze Audit for v$targetVersion.');
    ...
    final symbols = <FrozenApiSymbol>[
      ...
      const FrozenApiSymbol(
        ...
        kind: FrozenApiSymbolKind.engine,
        definedInFile: 'lib/src/enterprise/policy/enterprise_policy_engine.dart',
        decision: ApiFreezeDecision.freezeAsPublic,
      ...
      const FrozenApiSymbol(
        ...
        kind: FrozenApiSymbolKind.engine,
        definedInFile: 'lib/src/enterprise/orchestration/enterprise_orchestration_engine.dart',
        decision: ApiFreezeDecision.freezeAsPublic,
      ...
      const FrozenApiSymbol(
        ...
        decision: ApiFreezeDecision.freezeAsPublic,
        rationale: 'Stateful controller driving Studio v2 interactive workspace.',
      ),
      const FrozenApiSymbol(
        ...
        decision: ApiFreezeDecision.freezeAsPublic,
        rationale: 'Theme token model with color palette, glow, and font configurations.',
      ),
      const FrozenApiSymbol(
        ...
        decision: ApiFreezeDecision.freezeAsPublic,
        rationale: 'Immutable configuration state snapshot for loaders and effects.',
      ),
      const FrozenApiSymbol(
        ...
        decision: ApiFreezeDecision.freezeAsPublic,
        rationale: 'Frame timing and real-time interactive preview coordinator.',
      ),
      const FrozenApiSymbol(
      ...
      const FrozenApiSymbol(
        ...
        kind: FrozenApiSymbolKind.engine,
        definedInFile: 'lib/src/studio_v2/persistence/studio_persistence_engine.dart',
        decision: ApiFreezeDecision.freezeAsPublic,
      ...
      const FrozenApiSymbol(
        ...
        kind: FrozenApiSymbolKind.engine,
        definedInFile: 'lib/src/studio_v2/extension/studio_extension_engine.dart',
        decision: ApiFreezeDecision.freezeAsPublic,
      ...
      const FrozenApiSymbol(
        ...
        kind: FrozenApiSymbolKind.engine,
        definedInFile: 'lib/src/studio_v2/release_candidate/release_candidate_engine.dart',
        decision: ApiFreezeDecision.freezeAsPublic,
        rationale: 'Release Candidate audit engine and gate verifier.',
      ),
    ];

    final frozenCount = symbols.where((s) => s.decision == ApiFreezeDecision.freezeAsPublic).length;
    final internalCount = symbols.where((s) => s.decision == ApiFreezeDecision.privatizeToSrc).length;
