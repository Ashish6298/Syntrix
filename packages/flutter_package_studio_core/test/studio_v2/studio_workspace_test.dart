...
void main() {
  ...
  group('Phase 10.2: Studio Workspace Engine Operations', () {
    test('Selects loader, theme, and mutates animation/particle/physics configurations', () {
      ...
      expect(workspaceEngine.session.activeLoaderId, equals('infinite_universe'));
      expect(controller.state.activeConfiguration.targetLoaderId, equals('infinite_universe'));

      workspaceEngine.selectTheme('solar_flare');
      expect(workspaceEngine.session.activeThemeId, equals('solar_flare'));
      expect(controller.state.activeConfiguration.selectedThemeId, equals('solar_flare'));

      // 2. Update Animation Config
      workspaceEngine.updateAnimationConfig(speed: 2.0, intensity: 1.5, scale: 1.2);
      ...
      expect(workspaceEngine.session.configuration.particleOpacity, equals(0.9));
      ...
      workspaceEngine.updateRenderingConfig(shadersEnabled: false, isInteractive: true);
    ...
    test('Switches output tab and updates live performance telemetry', () {
      ...
      expect(workspaceEngine.session.activeOutputTab, equals(WorkspaceOutputTab.performanceMetrics));
    ...
    test('Generates production-ready Flutter code conforming to configuration', () {
      ...
      expect(code, contains('// Production-ready Flutter Widget generated by Syntrix Studio v2'));
  ...
  group('Phase 10.2: Studio Workspace Renderer', () {
    test('Renders ASCII 4-quadrant layout, Markdown summary, and JSON data', () {
      ...
      // 1. ASCII layout
      final ascii = StudioWorkspaceRenderer.renderAsciiWorkspace(workspaceEngine.session);
      ...
      final markdown = StudioWorkspaceRenderer.renderMarkdown(workspaceEngine.session, workspaceEngine);
